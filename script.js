...
const playerDatabase = [
    ...
    { name: "새까망", position: "ST" },
    { name: "랑뮤", position: "ST" },
    { name: "아야네세나", position: "GK / ST" },
    { name: "녹초", position: "WF / ST" },
    { name: "강단해", position: "WF" },
    ...
    { name: "우엉", position: "WF" },
    { name: "치유", position: "WF" },
    { name: "쥬멩이", position: "WF / CM" },
    { name: "나비", position: "WF" },
    { name: "유쁠리", position: "WF" },
    { name: "예다", position: "WF / CM" },
    { name: "달타", position: "WF" },
    { name: "유이담", position: "WF / ST" },
    ...
    { name: "온리유", position: "WF / ST" },
    { name: "찰리씨", position: "WF / CB" },
    { name: "고티", position: "WF / CAM" },
    ...
    { name: "카푸", position: "FB" },
    { name: "댕강", position: "FB" },
    { name: "아오이히로", position: "FB" },
    { name: "햇비", position: "FB" },
    { name: "박하", position: "CDM" },
    { name: "베지", position: "FB" },
    { name: "유키라", position: "FB" },
    { name: "닌닌", position: "FB" },
    { name: "야무지", position: "FB / WF" },
    { name: "이메이", position: "FB" },
    { name: "지연율", position: "FB / CB" },
    ...
    { name: "샬롯", position: "GK" },
    { name: "나옹이빵", position: "NONE" },
    { name: "밑줄", position: "NONE" },
    { name: "먹토끼", position: "NONE" },
    { name: "덕월", position: "NONE" },
    { name: "묭씨", position: "NONE" },
    { name: "수또리", position: "NONE" },
    { name: "코메", position: "NONE" },
    { name: "바보라", position: "NONE" },
    { name: "파밍조", position: "NONE" },
    { name: "문버터", position: "NONE" },
    { name: "루미밈", position: "NONE" },
    { name: "연솔이", position: "NONE" },
    { name: "라비타", position: "NONE" },
    { name: "냐무", position: "NONE" },
    { name: "라모", position: "NONE" },
    { name: "쏭이", position: "NONE" },
    { name: "낑토순", position: "NONE" },
    { name: "미유냥", position: "NONE" },
    { name: "유메밍", position: "NONE" },
    { name: "그믐이", position: "NONE" },
    { name: "츠키토", position: "NONE" },
    { name: "정나은양", position: "NONE" },
    { name: "마리", position: "NONE" },
    { name: "강다래", position: "NONE" },
    { name: "시로현", position: "NONE" },
    { name: "보라지효", position: "NONE" },
    { name: "묵아", position: "NONE" },
    { name: "주예나", position: "NONE" },
    { name: "허니론", position: "NONE" }
];
...
function filterPlayersByPosition(position) {
    ...
    // 해당 포지션에 맞는 선수들만 필터링하여 표시 (포지션이 'ALL'인 선수도 포함)
    playerDatabase.filter(player => player.position.includes(position) || player.position.includes('ALL'))
        .forEach(player => createPlayerButton(player, allPlayersContainer));
}
